...
@Component({
  selector: 'app-camp-surgeryunderwent-patients-reports',
  templateUrl: './camp-surgeryunderwent-patients-reports.component.html',
  styleUrls: ['./camp-surgeryunderwent-patients-reports.component.less'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class CampSurgeryunderwentPatientsReportsComponent implements OnInit {
  @ViewChild('CampSurgeryunderwentPatientsReports') Form: NgForm
  ...
  ngOnInit()
  {
    ...
    var Pathname = "Camp/CampSurgeryunderwentPatientsReports";
    var n = Pathname;
    ...
    if (sstring == false) {
      if (Objdata.find(el => el.Parentmoduledescription === Pathname)) {
        ...
        this.commonService.getListOfData('Common/Getlogdetails/' + localStorage.getItem("CompanyID") + '/' + localStorage.getItem("Doctorname") + '/' + "CampScreCampSurgeryunderwentPatientsReportsenedpatientsReports").subscribe(data => {
      ...
      if (Objdata.find(el => el.Parentmoduledescription === Pathname)) {
        ...
        this.commonService.getListOfData('Common/Getlogdetails/' + localStorage.getItem("CompanyID") + '/' + localStorage.getItem("Doctorname") + '/' + "CampSurgeryunderwentPatientsReports").subscribe(data => {
          this.router.navigate(['dash']);
        });
      }
    }
  ...
  onSubmit(form: NgForm) {
    ...
    if (form.valid) {
      ...
      this.commonService.getListOfData('Help/getCampSurgeryunderwentpatients/' + this.M_CampName.Value + '/' + Fromdate + '/' + Todate + '/' + parseInt(localStorage.getItem("CompanyID"))).subscribe(data => {
