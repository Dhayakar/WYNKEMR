...
@Component({
  selector: 'app-campto-hospitalvisitedpatients-reports',
  templateUrl: './campto-hospitalvisitedpatients-reports.component.html',
  styleUrls: ['./campto-hospitalvisitedpatients-reports.component.less'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class CamptoHospitalvisitedpatientsReportsComponent implements OnInit {
  @ViewChild('CamptoHospitalvisitedpatientsReports') Form: NgForm
  ...
  ngOnInit()
  {
    ...
    var Pathname = "Camp/Camptohospitalvisisted";
    var n = Pathname;
    ...
    if (sstring == false) {
      if (Objdata.find(el => el.Parentmoduledescription === Pathname)) {
        ...
        this.commonService.getListOfData('Common/Getlogdetails/' + localStorage.getItem("CompanyID") + '/' + localStorage.getItem("Doctorname") + '/' + "CamptoHospitalvisitedpatientsReports").subscribe(data => {
  ...
  onSubmit(form: NgForm) {
    ...
    if (form.valid) {
      ...
      this.commonService.getListOfData('Help/getCamptoHospitalvisitedpatients/' + this.M_CampName.Value + '/' + Fromdate + '/' + Todate + '/' + parseInt(localStorage.getItem("CompanyID"))).subscribe(data => {
